...
def get_current_candidate(current_user: User = Depends(get_current_active_user)):
    """Get current user if they are a candidate"""
...
def get_current_recruiter(current_user: User = Depends(get_current_active_user)):
